...
Hemoglobin A1C Test      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" name="a1c"     value="" placeholder="Enter your A1C test value" />*Please enter in mg/dL only<br><br> 
...
if($_GET['submit'])
{
	...
	if($a!="" && $h!="" && $w!="" && $i1!="" && $i2!="" && $g1!="" && $g2!="" && $a1!="" && $o!="" && $dpf!="" && $b1!="" && $b2!=""  && $name!="" )
	{
			...
			$query1="INSERT INTO exercise VALUES('$e1','$e2','$e3','$e4','$e5','$e6','$e7','$e8','$e9','$e10','$e11','$et','$name','$t')"; 
			$data2 = mysqli_query($conn,$query1);

			$query2="INSERT INTO diet VALUES('$d1','$d2','$d3','$d4','$d5','$dt','$name','$t')";
			$data3 = mysqli_query($conn,$query2);
				if($data2)
				{
					...
					$query="INSERT INTO DIABETES VALUES('$a','$h','$w','$i1','$i2','$g1','$g2','$dpf','$b1','$b2','$a1','$o','Diabetic','$name','$t')";    
					...
					else if($flag2!=0)
					{
							...
							$query="INSERT INTO DIABETES VALUES('$a','$h','$w','$i1','$i2','$g1','$g2','$dpf','$b1','$b2','$a1','$o','Prediabetic','$name','$t')";    
						$data = mysqli_query($conn,$query);
					...
					{		
						...
						$query="INSERT INTO DIABETES VALUES('$a','$h','$w','$i1','$i2','$g1','$g2','$dpf','$b1','$b2','$a1','$o','Healthy/ No Diabetes','$name','$t')";    
						$data = mysqli_query($conn,$query);
