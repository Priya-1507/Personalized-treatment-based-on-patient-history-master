...
<html>
<head>
	<title>Visualization of Output</title>
...
<p align="right"><a href="visualization.php" class="btn btn-success" >Back</a> </p>
		...
		<?php endif ?>
			...
			<h3>We provide Visualization of the  Results generated by the system in the form of Bar Graph.
			<br>
			<h3>Click on the respective buttons to see the Visualization. 
			<br>
			<center>		
			<a href="vexercise.php" class="btn btn-success" >Exercise</a> 

			<a href="vdiet.php" class="btn btn-success" >Diet</a> 
