	...
	<div class="wrap">
		...
		<div>
			...
			<h1 style="display: block;">Welcome To MyFitness!</h1>
              <h4>  <p>MyFitness is an Application which provides personalized recommendation to its users in the form of diet and exercise. The users can get the prediction whether they have diabetes or not. If they are predicted positive then personalized diet and exercise are recommended to the users.</p> 
