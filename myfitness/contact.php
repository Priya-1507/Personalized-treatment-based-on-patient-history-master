		...
		<div id="fther1">
			...
			<div id="des1"> 
			   ...
			   <p id="th" style="font-size:20px;font-family:Gill Sans Nova;font-weight:bold;">
			   	<h4><center>If you face any kind of difficulties while operating the application you can reach us any time between<br> 10:00 AM TO 6:00 PM Monday to Saturday <br>(Excluding Public Holidays) <br>Below we have provided our Contact details <br> Please feel free to contact in case of difficulties			   	<br></center>
			   	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-whatsapp" aria-hidden="true" style="font-size:30px;"></i>
			   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p style="font-size:20px;font-family:Gill Sans Nova;font-weight:bold;">Anuja Tendulkar->7582569475</p><br>
			   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-envelope" aria-hidden="true" style="font-size:30px;"></i>
			   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p style="font-size:20px;font-family:Gill Sans Nova;font-weight:bold;">Anuja Tendulkar->anujatendulkar5@gmail.com</p><br>

			   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-whatsapp" aria-hidden="true" style="font-size:30px;"></i>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p style="font-size:20px;font-family:Gill Sans Nova;font-weight:bold;">Priya Maurya->9325481262</p><br>
			   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-envelope" aria-hidden="true" style="font-size:30px;"></i>
			   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p style="font-size:20px;font-family:Gill Sans Nova;font-weight:bold;">Priya Maurya->priyamaurya123@gmail.com</p><br>
