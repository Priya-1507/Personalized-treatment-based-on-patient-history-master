...
<div class="wrap">
		...
		<div class="header">
			...
			<div>
			 ...
			 {
			 echo "<b>Welcome,</b>".$_SESSION['name']."&nbsp;&nbsp;&nbsp;<a href=\"logout.php\" class=\"btn btn-info\"></a>";
			 }
			 else
			 {
			 ?><br><br><br>
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<a class="brand" href="reservation.php"></a>
				<a class="brand" href="reservation.php"></a>
				<a class="brand" href="excerise.php">EXERCISE</a>
...
else
{
	...
	if($n1!="" && $h!="" && $w!="" && $i1!="" && $i2!="" )
	{
			...
			$query="INSERT INTO profile VALUES('$n1','$h','$w','$i1','$i2','$t')";
			$data = mysqli_query($conn,$query);
